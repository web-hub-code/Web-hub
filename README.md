...
body{background:linear-gradient(135deg,#0f0f0f,#120028,#1a0028,#000000);color:#fff;overflow-x:hidden;}
a{text-decoration:none;color:#00ffff;transition:0.3s;} a:hover{color:#ff0040;}
