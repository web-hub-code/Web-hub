...
Khan Studio provides premium digital services: Website Development, Video Editing, Branding, Thumbnails, SEO & Social Media. Our mission is to deliver **modern, neon-glowing, professional results** for every client.
</p>
</section>
...
<div class="slider-card" style="display:flex;align-items:center;"><img src="https://picsum.photos/60/60?random=5" class="photo-circle"><div><p>"Amazing experience!"</p><p>- Usman</p></div></div>
<div class="slider-card" style="display:flex;align-items:center;"><img src="https://picsum.photos/60/60?random=6" class="photo-circle"><div><p>"Top-notch quality."</p><p>- Maria</p></div></div>
<div class="slider-card" style="display:flex;align-items:center;"><img src="https://picsum.photos/60/60?random=7" class="photo-circle"><div><p>"Loved the neon design."</p><p>- Aliya</p></div></div>
<div class="slider-card" style="display:flex;align-items:center;"><img src="https://picsum.photos/60/60?random=8" class="photo-circle"><div><p>"Professional service!"</p><p>- Bilal</p></div></div>
<div class="slider-card" style="display:flex;align-items:center;"><img src="https://picsum.photos/60/60?random=9" class="photo-circle"><div><p>"Creative and fast!"</p><p>- Ayesha</p></div></div>
<div class="slider-card" style="display:flex;align-items:center;"><img src="https://picsum.photos/60/60?random=10" class="photo-circle"><div><p>"Loved the collaboration."</p><p>- Imran</p></div></div>
<!-- Add more to make 20–25 -->
</div>
<button class="slider-btn next">&#10095;</button>
</div>
</section>
...
<div class="faq-card"><h3>How can I order a service?</h3><div class="faq-content"><p>Fill contact form or reach via email/social links.</p></div></div>
<div class="faq-card"><h3>Delivery Time?</h3><div class="faq-content"><p>Usually 1–7 days depending on service complexity.</p></div></div>
<div class="faq-card"><h3>Do you provide revisions?</h3><div class="faq-content"><p>Yes, unlimited revisions until client satisfaction.</p></div></div>
</div>
</section>
...
let index=0;
prev.addEventListener('click',()=>{index--; if(index<0) index=track.children.length-1; track.style.transform=`translateX(-${index*320}px)`;});
next.addEventListener('click',()=>{index++; if(index>=track.children.length) index=0; track.style.transform=`translateX(-${index*320}px)`;});
});
